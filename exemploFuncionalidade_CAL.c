...
int main(){
    ...
    code[ 0].f = JMP; code[ 0].l = 0; code[ 0].a = 10;
    code[ 1].f = JMP; code[ 1].l = 0; code[ 1].a =  2;
    code[ 2].f = INT; code[ 2].l = 0; code[ 2].a =  5;
    code[ 3].f = LIT; code[ 3].l = 0; code[ 3].a = 13;
    code[ 4].f = STO; code[ 4].l = 0; code[ 4].a =  3;
    code[ 5].f = LIT; code[ 5].l = 0; code[ 5].a =  1;
    code[ 6].f = STO; code[ 6].l = 1; code[ 6].a =  3;
    code[ 7].f = LIT; code[ 7].l = 0; code[ 7].a =  7;
    code[ 8].f = STO; code[ 8].l = 0; code[ 8].a =  4;
    code[ 9].f = OPR; code[ 9].l = 0; code[ 9].a =  0;
    code[10].f = INT; code[10].l = 0; code[10].a =  5;
    code[11].f = LIT; code[11].l = 0; code[11].a =  3;
    code[12].f = STO; code[12].l = 0; code[12].a =  3;
    code[13].f = LIT; code[13].l = 0; code[13].a =  0;
    code[14].f = STO; code[14].l = 0; code[14].a =  4;
    code[15].f = CAL; code[15].l = 0; code[15].a =  2;
    code[16].f = OPR; code[16].l = 0; code[16].a =  0; // return
