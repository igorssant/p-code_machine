...
int main(){
    ...
    code[ 0].f = INT; code[ 0].l = 0; code[ 0].a = 5; // reserva 5 posicoes na memoria; 3 para sistema; 2 para usuario.
    code[ 1].f = LIT; code[ 1].l = 0; code[ 1].a = 1; // variavel auxiliar
    code[ 2].f = STO; code[ 2].l = 0; code[ 2].a = 3; // armazena na 1ra posicao livre da memoria
    code[ 3].f = LIT; code[ 3].l = 0; code[ 3].a = 1; // acumulador de FIB
    code[ 4].f = STO; code[ 4].l = 0; code[ 4].a = 4; // armazena na 2da posicao livre da memoria
    code[ 5].f = LOD; code[ 5].l = 0; code[ 5].a = 3; // carrega variavel auxiliar na pilha
    code[ 6].f = LOD; code[ 6].l = 0; code[ 6].a = 4; // carrega acumulador de FIB na pilha
    code[ 7].f = OPR; code[ 7].l = 0; code[ 7].a = 2; // soma acumulador de FIB com variavel auxiliar
    code[ 8].f = STO; code[ 8].l = 0; code[ 8].a = 3; // armazena na 1ra posicao livre da memoria
    code[ 9].f = LOD; code[ 9].l = 0; code[ 9].a = 3; // carrega variavel auxiliar na pilha
    code[10].f = LOD; code[10].l = 0; code[10].a = 4; // carrega acumulador de FIB na pilha
    code[11].f = OPR; code[11].l = 0; code[11].a = 2; // soma acumulador de FIB com variavel auxiliar
    code[12].f = STO; code[12].l = 0; code[12].a = 4; // armazena na 2da posicao livre da memoria
    code[13].f = LOD; code[13].l = 0; code[13].a = 3; // carrega variavel auxiliar na pilha
    code[14].f = LIT; code[14].l = 0; code[14].a = 5; // carrega limite na pilha
    code[15].f = OPR; code[15].l = 0; code[15].a = 10; // verifica que o contador eh menor do limite
    code[16].f = JPC; code[16].l = 0; code[16].a = 5; // se sao diferentes volta para a instrucao 5
    code[17].f = OPR; code[17].l = 0; code[17].a = 0; // return
