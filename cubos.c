...
int main(){
    ...
    code[19].f = LOD; code[19].l = 0; code[19].a = 4; // carrega a variavel auxiliar na pilha
    code[20].f = LOD; code[20].l = 0; code[20].a = 3; // carrega SOMA na pilha
    code[21].f = OPR; code[21].l = 0; code[21].a = 2; // multiplica SOMA * aux
    code[22].f = STO; code[22].l = 0; code[22].a = 3; // armazena na 1ra posicao livre da memoria
    code[23].f = LOD; code[23].l = 0; code[23].a = 5; // carrega a contador na pilha
    code[24].f = LIT; code[24].l = 0; code[24].a = 5; // carrega limite na pilha
    code[25].f = OPR; code[25].l = 0; code[25].a = 10;// varifica se contador eh menor que o limite
    code[26].f = JPC; code[26].l = 0; code[26].a = 7; // se sao diferentes volta para a instrucao 7
    code[27].f = OPR; code[27].l = 0; code[27].a = 0; // return
