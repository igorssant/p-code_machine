...
int main(){
    ...
    code[ 1].f = LIT; code[ 1].l = 0; code[ 1].a = 1; // contador de iteracao
    code[ 2].f = STO; code[ 2].l = 0; code[ 2].a = 3; // armazena na 1ra posicao livre da memoria
    code[ 3].f = LIT; code[ 3].l = 0; code[ 3].a = 1; // acumulador de fatorial
    code[ 4].f = STO; code[ 4].l = 0; code[ 4].a = 4; // armazena na 2da posicao livre da memoria
    code[ 5].f = LOD; code[ 5].l = 0; code[ 5].a = 3; // carrega contador na pilha
    code[ 6].f = LIT; code[ 6].l = 0; code[ 6].a = 1; // carrega 1 na pilha
    code[ 7].f = OPR; code[ 7].l = 0; code[ 7].a = 2; // incrementa contador
    code[ 8].f = STO; code[ 8].l = 0; code[ 8].a = 3; // armazena na 1ra posicao livre da memoria
    code[ 9].f = LOD; code[ 9].l = 0; code[ 9].a = 3; // carrega contador na pilha
    code[10].f = LOD; code[10].l = 0; code[10].a = 4; // carrega acumulador fact na pilha
    code[11].f = OPR; code[11].l = 0; code[11].a = 4; // multiplica contador e acumular de fact 
    code[12].f = STO; code[12].l = 0; code[12].a = 4; // armazena na 2da posicao livre da memoria
    code[13].f = LOD; code[13].l = 0; code[13].a = 3; // carrega contador na pilha
    code[14].f = LIT; code[14].l = 0; code[14].a = 5; // carrega limite na pilha
    code[15].f = OPR; code[15].l = 0; code[15].a = 9; // verifica que o contador eh diferente do limite
