...
int main(){
    ...
    code[15].f = LOD; code[15].l = 0; code[15].a = 5; // carrega o contador na pilha
    code[16].f = LOD; code[16].l = 0; code[16].a = 4; // carrega a auxiliar na pilha
    code[17].f = OPR; code[17].l = 0; code[17].a = 4; // multiplica contador * auxiliar
    code[18].f = STO; code[18].l = 0; code[18].a = 4; // armazena na 2da posicao livre da memoria
    code[19].f = LOD; code[19].l = 0; code[19].a = 5; // carrega o contador na pilha
    code[20].f = LOD; code[20].l = 0; code[20].a = 4; // carrega a auxiliar na pilha
    code[21].f = OPR; code[21].l = 0; code[21].a = 4; // multiplica contador * auxiliar
    code[22].f = STO; code[22].l = 0; code[22].a = 4; // armazena na 2da posicao livre da memoria
    code[23].f = LOD; code[23].l = 0; code[23].a = 4; // carrega a variavel auxiliar na pilha
    code[24].f = LOD; code[24].l = 0; code[24].a = 3; // carrega SOMA na pilha
    code[25].f = OPR; code[25].l = 0; code[25].a = 2; // multiplica SOMA * aux
    code[26].f = STO; code[26].l = 0; code[26].a = 3; // armazena na 1ra posicao livre da memoria
    code[27].f = LOD; code[27].l = 0; code[27].a = 5; // carrega a contador na pilha
    code[28].f = LIT; code[28].l = 0; code[28].a = 5; // carrega limite na pilha
    code[29].f = OPR; code[29].l = 0; code[29].a = 10;// varifica se contador eh menor que o limite
    code[30].f = JPC; code[30].l = 0; code[30].a = 7; // se sao diferentes volta para a instrucao 7
    code[31].f = OPR; code[31].l = 0; code[31].a = 0; // return
