...
int main(){
    ...
    code[ 1].f = LIT; code[ 1].l = 0; code[ 1].a = 1; // acumulador de FIB
    code[ 2].f = STO; code[ 2].l = 0; code[ 2].a = 3; // armazena na 1ra posicao livre da memoria
    code[ 3].f = LIT; code[ 3].l = 0; code[ 3].a = 0; // variavel auxiliar
    ...
    code[11].f = LOD; code[11].l = 0; code[11].a = 4; // carrega a variavel auxiliar na pilha
    code[12].f = LOD; code[12].l = 0; code[12].a = 3; // carrega FIB na pilha
    code[13].f = LOD; code[13].l = 0; code[13].a = 3; // carrega FIB na pilha
    code[14].f = STO; code[14].l = 0; code[14].a = 4; // armazena na 2da posicao livre da memoria
    code[15].f = OPR; code[15].l = 0; code[15].a = 2; // soma fib(n) + fib (n-1)
    code[16].f = STO; code[16].l = 0; code[16].a = 3; // armazena na 1ra posicao livre da memoria
    code[17].f = LOD; code[17].l = 0; code[17].a = 5; // carrega o contador no topo da pilha
    code[18].f = LIT; code[18].l = 0; code[18].a = 10;// carrega limite na pilha
    code[19].f = OPR; code[19].l = 0; code[19].a = 10;// varifica se contador eh menor que o limite
    code[20].f = JPC; code[20].l = 0; code[20].a = 7; // se sao diferentes volta para a instrucao 5
    code[21].f = OPR; code[21].l = 0; code[21].a = 0; // return
